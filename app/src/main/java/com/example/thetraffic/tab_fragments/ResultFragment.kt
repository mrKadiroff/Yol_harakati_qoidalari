...
class ResultFragment : Fragment() {
    ...
    private fun setData() {
        val cameradata = arguments?.getSerializable("data") as CameraModel
        binding.toolbar.title = cameradata.nomi
        binding.name.text = cameradata.nomi
        binding.description.text = cameradata.malumot
        binding.rasm.setImageURI(Uri.parse(cameradata.rasm))
